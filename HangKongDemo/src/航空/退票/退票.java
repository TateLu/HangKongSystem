...
public class 退票 extends JFrame implements ActionListener
{
	...
	private void tuiPiao()
	{
	    ...
	    else
	    {
	    	...
	    	if(childTuiPiaoShu.equals(""))
	    		childTuiPiaoShu="0";
	    	if(adultTuiPiaoShu.equals(""))
	    		adultTuiPiaoShu="0";
	...
	private float caculateTuiPiaoCost(int childTuiPiaoShu,int adultTuiPiaoShu)
	{
		...
		try
		{
			String sqlString = "select childFare,adultFare from Plane where flight='"+flight1+"'";
			...
			if (flight2.length() != 0)
			{
				String sqlString2 = "select childFare,adultFare from Plane where flight='"+flight2+"'";
	...
	private boolean getClientInfo(String dingdan,String id)
	{
		...
		{					
	    	...
	    	//System.out.println("leaveTime1"+leaveTime1);
