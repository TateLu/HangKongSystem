...
public class 删除面板 extends JPanel  implements ActionListener
{
	...
	public 删除面板()
	{
		...
		flight2.addActionListener(new ActionListener()
		{
	        ...
	        stmt = con.createStatement();	
				...
				rs=stmt.executeQuery("select week from Plane where flight='"+flight+"'");
				while(rs.next())
				{
	...
	public static void main(String[] args)
	{
		...
		frame.getContentPane().add(new 删除面板());
