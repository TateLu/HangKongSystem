...
public class 更新面板 extends JPanel implements ItemListener,ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource() instanceof JButton)
		{
			...
			else
			{
				...
				{
					String sqlString = "select flight from Plane where flight='" + jtf[0].getText().trim() + "'";
	...
	public static void main(String[] args)
	{
		...
		frame.getContentPane().add(new 更新面板());
