...
public class 插入面板 extends JPanel
{
	...
	public 插入面板()
	{
		...
		p1.add(label[0]=new JLabel("航线编号"));
...
//		p1.add(jtf[7]=new JTextField(10));
		p1.add(label[0]=new JLabel("头等舱票价"));
		p1.add(jtf[8]=new JTextField(10));
		p1.add(label[0]=new JLabel("经济舱票价"));
...
//		p2.add(button[2]=new JButton("更新"));
		...
		button[0].addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					JOptionPane.showMessageDialog(null,"航线编号不正确","错误",JOptionPane.ERROR_MESSAGE);
					return;
				}				
				 ...
				 {
				 	JOptionPane.showMessageDialog(null,"座位数为空","错误",JOptionPane.ERROR_MESSAGE);
				 	return;
				 }
				 ...
				 {
				 	JOptionPane.showMessageDialog(null,"起飞地点为空","错误",JOptionPane.ERROR_MESSAGE);
				 	return;
				 }
				 ...
				 {
				 	JOptionPane.showMessageDialog(null,"降落地点为空","错误",JOptionPane.ERROR_MESSAGE);
				 	return;
				 }				 
	...
	public static void main(String[] args)
	{
		...
		frame.getContentPane().add(new 插入面板());
