...
public class UpdateComboBox extends Thread
{
	...
	{
		∆’Õ®≤È—Ø.updateFlightComboBox(newFlightNum,insertOrDelete);				
		…æ≥˝√Ê∞Â.updateFlightComboBox(newFlightNum,insertOrDelete);	
	}
	
	private void updateAirFirmComboBox(String newAirFirm,int insertOrDelete)
	{
		∆’Õ®≤È—Ø.updateAirFirmComboBox(newAirFirm,insertOrDelete);		
		◊€∫œ≤È—Ø.updateAirFirmComboBox(newAirFirm,insertOrDelete);		
	}
	
	private void updatePlaceComboBox(String newPlace,int insertOrDelete)
	{
		∆’Õ®≤È—Ø.updatePlaceComboBox(newPlace,insertOrDelete);		
		◊€∫œ≤È—Ø.updatePlaceComboBox(newPlace,insertOrDelete);		
		…æ≥˝√Ê∞Â.updateCityComboBox(newPlace,insertOrDelete);
	}
}